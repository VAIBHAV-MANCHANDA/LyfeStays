    ...
    <div className="auth">
      <div className="auth__left">
        ...
        <div className="auth__left-content">
          ...
          <p className="auth__left-sub">Sign in to continue your extraordinary journey with LyfeStays.</p>
          <div className="auth__left-props">
            {['Manage your bookings', 'Save favourite stays', 'Earn LyfeCoins rewards', 'Exclusive member deals'].map((p) => (
              <div key={p} className="auth__left-prop">✅ {p}</div>
            ))}
          </div>
          <div className="auth__left-bg-card">
            <img src="https://images.unsplash.com/photo-1571896349842-33c89424de2d?w=500&q=80" alt="" />
      ...
      <div className="auth__right">
        <div className="auth__form-card">
          ...
          <p className="auth__form-sub">Don't have an account? <Link to="/register" className="auth__link">Create one free</Link></p>

          {/* Social Sign In */}
          <div className="auth__social">
            <button className="auth__social-btn">🔵 Continue with Google</button>
            <button className="auth__social-btn">⚫ Continue with Apple</button>
          </div>
